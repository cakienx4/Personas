...
CQ_JSON_DEFAULT = os.path.join(BASE_DIR, "cq_validation_results_gemini_1_3_5.json")
OUT_JSON    = os.path.join(BASE_DIR, "ontology_score_results_gemini_1_3_5.json")
OUT_MD      = os.path.join(BASE_DIR, "ontology_score_report_gemini_1_3_5.md")
